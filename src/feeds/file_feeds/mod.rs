...
impl VtClient {
    ...
    pub async fn file_feed_behaviours(&self, time: &str) -> VtResult<Vec<Root>> {
    ...
    pub async fn file_feed_behaviours_hourly(&self, time: &str) -> VtResult<Vec<Root>> {
    ...
    pub async fn file_feed_hourly(&self, time: &str) -> VtResult<Vec<Root>> {
